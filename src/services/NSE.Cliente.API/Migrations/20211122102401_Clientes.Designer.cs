...
namespace NSE.Cliente.API.Migrations
{
    ...
    [Migration("20211122102401_Clientes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSE.Cliente.API.Models.Clientess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.OwnsOne("NSE.Core.DomainObjects.Cpf", "Cpf", b1 =>
                        {
                            ...
                            b1.HasKey("ClientessId");

                            b1.ToTable("Clientes");

                            b1.WithOwner()
                                .HasForeignKey("ClientessId");
                        });
            ...
            modelBuilder.Entity("NSE.Cliente.API.Models.Endereco", b =>
                {
                    b.HasOne("NSE.Cliente.API.Models.Clientess", "Cliente")
                        .WithOne("Endereco")
